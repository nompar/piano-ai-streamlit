...
def create_video(input_midi: str, 
	...
	subprocess.call((f"fluidsynth -ni -r 44100 -R 1 -o synth.reverb.level=0.7 /Users/hadriendecaumont/code/nompar/piano-ai-streamlit/asset/SalC5Light2.sf2 {input_midi} -F {sound_file}").split())
